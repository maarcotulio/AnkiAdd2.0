...
export function Definition({ className, title, data }: DefinitionProps) {
  ...
  return (
    <div className={cn(className)}>
      <div className="font-libreBaskerville w-full max-w-xl text-left text-7xl">
      ...
      <div className="mt-8">
        {data.map((section) => (
          <div
            ...
            className="flex flex-col gap-2 max-w-xl text-left mb-8"
          >
            ...
            {section.definition?.map((defs: Def, index: number) => (
              <div key={index}>
                <p className="w-full text-lg text-bold">
